    ...
    return (
        <Carousel fade activeIndex={index} onSelect={handleSelect}>
            <Carousel.Item>
                ...
                />
                <Carousel.Caption>
                    <h1 className='text-dark my-0'>Home Gym Equipment</h1>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
                <img
                ...
                <Carousel.Caption>
                    <h1 className='text-dark my-0'>Strength Training Equipment</h1>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
                <img
                ...
                <Carousel.Caption>
                    <h1 className='text-dark my-0'>Cardio Equipment</h1>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
                <img
                ...
                <Carousel.Caption>
                    <h1 className='text-dark my-0'>Boxing Equipment</h1>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
                <img
                ...
                <Carousel.Caption>
                    <h1 className='text-dark my-0'>Rubber Flooring</h1>
                </Carousel.Caption>
            </Carousel.Item>
        </Carousel>
    );
